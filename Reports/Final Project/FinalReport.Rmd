---
title: "Identifying Value in the NFL Draft"
author: "Caleb ONeel"
output:
...
```{r, message=FALSE, include=TRUE, warning=FALSE, out.width="50%"}
(plot(model4))
```
